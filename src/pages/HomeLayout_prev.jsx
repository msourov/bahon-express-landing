...
const items = [
  { key: "tracking", label: "Tracking", link: "/tracking" },
          ...
          <div className="container">
              ...
              <Row gutter={16} style={{ justifyContent: "center" }}>
                ...
                <Col className="gutter-row" lg={6} md={8} sm={12}>
                  ...
                  >
                    ...
                    <p style={{ fontSize: "1rem" }}>
                      Collection prior 4pm, we guarantee delivery within 24
                      hours within city limits. We shall SMS prior to delivery.
                    </p>
                  </Card>
                </Col>
                ...
                <Col className="gutter-row" lg={6} md={8} sm={12}>
                  ...
                  >
                    ...
                    <p style={{ fontSize: "1rem" }}>
                      We provide delivery services to Dhaka and sub-urban/areas
                      of Dhaka. We are expanding our coverages to meet the daily
                      growing challenges.
                    </p>
                  </Card>
                </Col>
                ...
                <Col className="gutter-row" lg={6} md={8} sm={12}>
                  ...
                  >
                    ...
                    <p style={{ fontSize: "1rem" }}>
                      Our delivery staff shall safely deliver your parcels to
                      your customers. After fulfilling the transaction, Bahon
                      Express shall release the payment to your preferred
                      account.
                    </p>
                  </Card>
                </Col>
                ...
                <Col className="gutter-row" lg={6} md={8} sm={12}>
                  ...
                  >
                    ...
                    <p style={{ fontSize: "1rem" }}>
                      ...
                      provide complimentary assistance to register an account
                      with Bahon. We are just a call away for your queries,
                      should you have difficulties in logging into the system.
                    </p>
                  </Card>
                </Col>
              </Row>
            ...
            <div className="story-wrapper">
              ...
              <p>
                ...
                management services to local merchants in Bangladesh.
              </p>
              <div className="story-text">
                ...
                <p>
                  Bahon Express Ltd., founded in 2020, provides logistic
                  management services to local merchants in Bangladesh. We
                  deliver all sorts of E-commerce packages both B2B and B2C with
                  the ultimate delivery solution. Bahon Express Ltd. has vast
                  ...
                  competency, establishing itself as one of the leading
                  logistics service providing companies. Our comprehensive
                  package of services and solutions cater to all of the needs of
                  merchants. With a responsible, equitable solution, we make
                  customized logistical support to satisfy the priorities of
                  each customer.
                </p>
              </div>
            </div>
